...
CREATE INDEX IF NOT EXISTS idx_word_of_the_day_date ON public.word_of_the_day(word_date);
...
DROP POLICY IF EXISTS "Admins can create word of the day" ON public.word_of_the_day;
DROP POLICY IF EXISTS "Admins can update word of the day" ON public.word_of_the_day;
DROP POLICY IF EXISTS "Admins can delete word of the day" ON public.word_of_the_day;
