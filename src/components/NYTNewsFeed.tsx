    ...
    <div className="space-y-4">
      ...
      <div className="grid gap-4">
        {articles.map((article, index) => (
          <Card key={`${article.url}-${index}`} className="bg-gray-900/50 border-gray-800 hover:bg-gray-800/50 transition-colors group">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 text-xs text-gray-500">
                    ...
                    <Button
                      ...
                      size="sm"
                      asChild
                      className="text-wikitok-red hover:text-wikitok-red/80 hover:bg-wikitok-red/10 self-start sm:self-auto"
                    >
                      <a
                        href={article.url}
                        target="_blank"
