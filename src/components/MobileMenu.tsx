  ...
  return (
    <>
      <button
        ...
        className={`p-2 rounded-full ${isDark ? 'bg-black/20 text-white' : 'bg-white/80 text-gray-700'}`}
      >
          ...
          <div className="space-y-4">
            {menuItems.map((item, index) => (
              <button
                ...
                className={item.className || `w-full flex items-center gap-3 p-3 rounded-lg ${
                  item.isActive 
