    ...
    <div className="fixed top-0 left-0 right-0 z-50 bg-gradient-to-b from-black/50 to-transparent backdrop-blur-sm">
      <div className="flex items-center justify-between px-6 py-2 max-w-7xl mx-auto">
        ...
        <div className="flex items-center gap-4">
          <LanguageSelector />
          <div 
            className={`flex items-center gap-2 cursor-pointer transition-colors duration-300 text-white hover:text-wikitok-red`} 
        ...
        <div className="flex items-center gap-4">
          <Compass 
            className={`w-5 h-5 cursor-pointer transition-colors duration-300 ${
              isDiscoverPage ? "text-wikitok-red" : "text-white hover:text-wikitok-red"
            }`} 
          ...
          <div className="text-xl font-bold text-wikitok-red cursor-pointer" onClick={() => navigate("/")}>
            WikTok
          </div>
        </div>
      </div>
